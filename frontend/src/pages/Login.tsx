...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-600 via-purple-500 to-blue-600 relative overflow-hidden">
      <div className="absolute top-10 left-10 text-white text-4xl">🛡️</div>
      <div className="absolute bottom-10 right-10 opacity-20 text-white text-6xl">📄</div>
